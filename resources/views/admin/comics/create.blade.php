...
<div class="container mb-5">
    ...
    <form action="{{route('comics.store')}}" method="post" class="card p-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="series" id="series" class="form-control" placeholder="" aria-describedby="seriesHlper" value="{{old('series')}}">
            <small id="seriesHlper" class="text-muted">Add the product series here</small>
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">Price</label>
            <input type="text" name="price" id="price" class="form-control" placeholder="" aria-describedby="priceHlper" value="{{old('price')}}">
            <small id="priceHlper" class="text-muted">Add the product price here</small>
        </div>
        <div class="mb-3">
            <label for="sale_date" class="form-label">Sale Date</label>
            <input type="text" name="sale_date" id="sale_date" class="form-control" placeholder="" aria-describedby="sale_dateHlper" value="{{old('sale_date')}}">
